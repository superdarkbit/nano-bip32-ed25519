var pow_initiate = function(threads, worker_path) {
	...
	if (isNaN(threads)) { threads = self.navigator.hardwareConcurrency ? (self.navigator.hardwareConcurrency - 1) : 2; }
	var workers = [];
...
module.exports = {
  'pow_initiate': pow_initiate,
  'pow_start': pow_start,
  'pow_terminate': pow_terminate,
  'pow_callback': pow_callback
}
